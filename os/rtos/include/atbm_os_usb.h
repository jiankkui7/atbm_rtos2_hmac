...
#define atbm_usb_rcvbulkpipe(a)	usb_rcvbulkpipe(a)
#define atbm_usb_sndbulkpipe(a)	usb_sndbulkpipe(a)
#define atbm_usb_sndctrlpipe(a) usb_sndctrlpipe(a)
#define atbm_usb_rcvctrlpipe(a) usb_rcvctrlpipe(a)
